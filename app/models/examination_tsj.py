...
class ExaminationTsj(Base):
    ...
    examination_tsj_tss = Column(Boolean, comment="同时视")
    examination_tsj_tss_sp = Column(VARCHAR(20), comment="同时视水平值")
    examination_tsj_tss_cz = Column(VARCHAR(20), comment="	同时视垂直值（R/L or L/R")
    examination_tsj_tss_cs_z = Column(VARCHAR(20), comment="同时视垂直值具体数值")
