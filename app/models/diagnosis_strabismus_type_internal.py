...
class DiagnosisStrabismusTypeInternal(Base):
    ...
    IE = Column(VARCHAR(20), comment="先天性(婴儿型)内斜视")
    CE = Column(Boolean, comment="共同性内斜视")
    SE = Column(VARCHAR(20), comment="继发性内斜视")
    NE = Column(VARCHAR(20), comment="非共同性内斜视")
    EN = Column(VARCHAR(20), comment="伴有眼球震颤的内斜视")
