...
class CRUDCase(CRUDBase[None, BaseInfo, None]):
    ...
    def getCaseCondition(
        ...
        for patient_i in patient:
            ...
            patient_dict['examinationCo'] = patient_i.examinationCo[0] if patient_i.examinationCo else ""
            patient_dict['examinationRo'] = patient_i.examinationRo[0] if patient_i.examinationRo else ""
            ...
            patient_dict['examinationEyeballsport'] = patient_i.examinationEyeballsport[0] if patient_i.examinationEyeballsport else ""
            ...
            patient_dict['leaveHospitalEyeballsport'] = patient_i.leaveHospitalEyeballsport[0] if patient_i.leaveHospitalEyeballsport else ""
            patient_dict['examinationCornea'] = patient_i.examinationCornea[0] if patient_i.examinationCornea else ""
